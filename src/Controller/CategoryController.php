        ...
        if ($form->isSubmitted() && $form->isValid()) {
            if ($form->get('image')->getData()) {
                ...
                try {
                    ...
                    $category->setImage($newFilename); // Set the new filename in the category
            ...
            $em->persist($category);
            $em->flush();
            return $this->redirectToRoute('category', ['category' => $category->getName()]);
        }
        // Return the view
        return $this->render('category/edit.html.twig', [
            // Pass the category object to the view
            'title' => 'Modifier la categorie ' . $category->getName(),
            'category' => $category,
            'editForm' => $form
        ]);
    }
